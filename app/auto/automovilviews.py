...
def s3off():
   s3.off()
   return "<h1> Corriste escena off en s3 </h1>"
@app.route("/s3/alarmwhite")
def s3alarmwhite():
   s3.alarmwhite()
   return "<h1> Corriste escena alarmwhite en s3 </h1>"
@app.route("/s3/green")
def s3green():
   s3.green()
   return "<h1> Corriste escena green en s3 </h1>"
@app.route("/s3/white")
def s3white():
   s3.white()
   return "<h1> Corriste escena white en s3 </h1>"
@app.route("/s3/blue")
def s3blue():
   s3.blue()
   return "<h1> Corriste escena blue en s3 </h1>"
@app.route("/s3/alarmblue")
def s3alarmblue():
   s3.alarmblue()
   return "<h1> Corriste escena alarmblue en s3 </h1>"
@app.route("/s3/red")
def s3red():
   s3.red()
   return "<h1> Corriste escena red en s3 </h1>"
